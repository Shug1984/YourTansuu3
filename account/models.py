...
class MyUser(AbstractBaseUser):
    ...
    last_name = models.CharField(verbose_name="名前(姓)", max_length=100)
    first_name = models.CharField(verbose_name="名前(名)", max_length=100)
    last_kana = models.CharField(verbose_name="フリガナ(姓)", max_length=100)
    first_kana = models.CharField(verbose_name="フリガナ(名)", max_length=100)
    ...
    building_name = models.CharField(verbose_name="建物名・部屋番号", max_length=300, blank=True, null=True)
    ...
    personal_image = models.ImageField(verbose_name="プロフィール画像", upload_to='account/user_images', blank=True, null=True)
