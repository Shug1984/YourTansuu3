...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('contents', '0003_auto_20211102_2223'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='item',
            name='item_type',
            field=models.ForeignKey(blank=True, db_column='item_type', default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='contents.itemtype', verbose_name='アイテム種類'),
        ),
        migrations.AlterField(
            model_name='item',
            name='purchase_place',
